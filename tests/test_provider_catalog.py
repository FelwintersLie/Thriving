...
class ProviderCatalogTests(unittest.TestCase):
    ...
    def test_provider_default_availability_when_no_templates_and_no_exceptions(self):
        profile = {"availability_templates": [], "exceptions": []}
        self.assertTrue(provider_is_available(profile, date_key="2026-01-06", weekday=1, start_minute=540, end_minute=600))

    def test_provider_lunch_enforcement_blocks_manual_overlap(self):
        profile = {
            "availability_templates": [{"weekday": 0, "windows": [{"start_minute": 480, "end_minute": 1020}]}],
            "exceptions": [],
            "enforce_lunch_break": True,
            "lunch_earliest_start_minute": 690,
            "lunch_latest_start_minute": 750,
        }
        self.assertFalse(provider_is_available(profile, date_key="2026-01-05", weekday=0, start_minute=700, end_minute=730))
